                    ...
                    <div style='background-color:#4fd2a5;'>
                        <div class='block-grid' style='Margin: 0 auto; min-width: 320px; max-width: 675px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: transparent;'>
                            <div style='border-collapse: collapse;display: table;width: 100%;background-color:transparent;'>
                                <!--[if (mso)|(IE)]>
                                    <table width='100%' cellpadding='0' cellspacing='0' border='0' style='background-color:#4fd2a5;'>
                                        <tr>
                                            <td align='center'>
                                        ...
                                        <div style='border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:30px; padding-bottom:30px; padding-right: 0px; padding-left: 0px;'>
                                            ...
                                            <div align='center' class='button-container' style='padding-top:15px;padding-right:10px;padding-bottom:10px;padding-left:10px;'>
                                                <!--[if mso]>
                                                    ...
                                                    <![endif]-->
                                                <a href='<?php echo base_url(true) . '/activate/' . $activationToken ?>' style='text-decoration:none;display:block;color:#ffffff;background-color:#007089;border-radius:25px;-webkit-border-radius:25px;-moz-border-radius:25px;width:35%; width:calc(35% - 2px);;border-top:1px solid #007089;border-right:1px solid #007089;border-bottom:1px solid #007089;border-left:1px solid #007089;padding-top:5px;padding-bottom:5px;font-family: Montserrat, Trebuchet MS , Lucida Grande , Lucida Sans Unicode , Lucida Sans , Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;'>
                                                    <span style='padding-left:20px;padding-right:20px;font-size:18px;display:inline-block;'><span style='font-size: 16px; line-height: 2; word-break: break-word; font-family: Montserrat,  Trebuchet MS, Lucida Grande , Lucida Sans Unicode , Lucida Sans , Tahoma, sans-serif; mso-line-height-alt: 32px;'><span data-mce-style='font-size: 16px; line-height: 32px;' style='font-size: 16px; line-height: 32px;'><span data-mce-style='font-size: 18px; line-height: 36px;' style='font-size: 18px; line-height: 36px;'><?php echo t('common.activate') ?></span></span></span></span>
                                                </a>
