<li class="collection-item avatar">
    ...
    <span class="title post-title" title="<?php echo $post['title'] ?>">
        <a class="teal-text post-title" href="<?php echo base_url() . '/' . current_lang() . '/post/' . $post['uuid'] ?>">
            <?php echo $post['title'] ?>
        </a>
    </span>
    <p>
    ...
    <a href="#modal-confirm" class="secondary-content modal-trigger" data-url="<?php echo base_url() . '/' . current_lang() ?>/my-posts/delete/<?php echo $post['uuid'] ?>">
